...
public final class RelationsServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.aruna.api.storage.services.v2.RelationsServiceProto.GetHierarchyRequest,
      com.aruna.api.storage.services.v2.RelationsServiceProto.GetHierarchyResponse> getGetHierarchyMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetHierarchy",
      requestType = com.aruna.api.storage.services.v2.RelationsServiceProto.GetHierarchyRequest.class,
      responseType = com.aruna.api.storage.services.v2.RelationsServiceProto.GetHierarchyResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.aruna.api.storage.services.v2.RelationsServiceProto.GetHierarchyRequest,
      com.aruna.api.storage.services.v2.RelationsServiceProto.GetHierarchyResponse> getGetHierarchyMethod() {
    io.grpc.MethodDescriptor<com.aruna.api.storage.services.v2.RelationsServiceProto.GetHierarchyRequest, com.aruna.api.storage.services.v2.RelationsServiceProto.GetHierarchyResponse> getGetHierarchyMethod;
      ...
      synchronized (RelationsServiceGrpc.class) {
        if ((getGetHierarchyMethod = RelationsServiceGrpc.getGetHierarchyMethod) == null) {
          RelationsServiceGrpc.getGetHierarchyMethod = getGetHierarchyMethod =
              io.grpc.MethodDescriptor.<com.aruna.api.storage.services.v2.RelationsServiceProto.GetHierarchyRequest, com.aruna.api.storage.services.v2.RelationsServiceProto.GetHierarchyResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetHierarchy"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.aruna.api.storage.services.v2.RelationsServiceProto.GetHierarchyRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.aruna.api.storage.services.v2.RelationsServiceProto.GetHierarchyResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void getHierarchy(com.aruna.api.storage.services.v2.RelationsServiceProto.GetHierarchyRequest request,
        io.grpc.stub.StreamObserver<com.aruna.api.storage.services.v2.RelationsServiceProto.GetHierarchyResponse> responseObserver) {
  ...
  public static final class RelationsServiceStub
     ...
     * </pre>
     */
    public void getHierarchy(com.aruna.api.storage.services.v2.RelationsServiceProto.GetHierarchyRequest request,
        io.grpc.stub.StreamObserver<com.aruna.api.storage.services.v2.RelationsServiceProto.GetHierarchyResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
  ...
  public static final class RelationsServiceBlockingStub
     ...
     * </pre>
     */
    public com.aruna.api.storage.services.v2.RelationsServiceProto.GetHierarchyResponse getHierarchy(com.aruna.api.storage.services.v2.RelationsServiceProto.GetHierarchyRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class RelationsServiceFutureStub
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.aruna.api.storage.services.v2.RelationsServiceProto.GetHierarchyResponse> getHierarchy(
        com.aruna.api.storage.services.v2.RelationsServiceProto.GetHierarchyRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        ...
        case METHODID_GET_HIERARCHY:
          serviceImpl.getHierarchy((com.aruna.api.storage.services.v2.RelationsServiceProto.GetHierarchyRequest) request,
              (io.grpc.stub.StreamObserver<com.aruna.api.storage.services.v2.RelationsServiceProto.GetHierarchyResponse>) responseObserver);
          break;
        default:
  ...
  public static final io.grpc.ServerServiceDefinition bindService(AsyncService service) {
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        ...
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.aruna.api.storage.services.v2.RelationsServiceProto.GetHierarchyRequest,
              com.aruna.api.storage.services.v2.RelationsServiceProto.GetHierarchyResponse>(
