...
public interface AddOidcProviderRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:aruna.api.storage.services.v2.AddOidcProviderRequest)
   ...
   */
  java.lang.String getNewAccessToken();
  /**
   * <code>string new_access_token = 1 [json_name = "newAccessToken"];</code>
