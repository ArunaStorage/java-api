...
public final class DataproxyServiceGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "aruna.api.dataproxy.services.v2.DataproxyService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.aruna.api.dataproxy.services.v2.RequestReplicationRequest,
      com.aruna.api.dataproxy.services.v2.RequestReplicationResponse> getRequestReplicationMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "RequestReplication",
      requestType = com.aruna.api.dataproxy.services.v2.RequestReplicationRequest.class,
      responseType = com.aruna.api.dataproxy.services.v2.RequestReplicationResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.aruna.api.dataproxy.services.v2.RequestReplicationRequest,
      com.aruna.api.dataproxy.services.v2.RequestReplicationResponse> getRequestReplicationMethod() {
    io.grpc.MethodDescriptor<com.aruna.api.dataproxy.services.v2.RequestReplicationRequest, com.aruna.api.dataproxy.services.v2.RequestReplicationResponse> getRequestReplicationMethod;
      ...
      synchronized (DataproxyServiceGrpc.class) {
        if ((getRequestReplicationMethod = DataproxyServiceGrpc.getRequestReplicationMethod) == null) {
          DataproxyServiceGrpc.getRequestReplicationMethod = getRequestReplicationMethod =
              io.grpc.MethodDescriptor.<com.aruna.api.dataproxy.services.v2.RequestReplicationRequest, com.aruna.api.dataproxy.services.v2.RequestReplicationResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "RequestReplication"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.aruna.api.dataproxy.services.v2.RequestReplicationRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.aruna.api.dataproxy.services.v2.RequestReplicationResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.aruna.api.dataproxy.services.v2.InitReplicationRequest,
      com.aruna.api.dataproxy.services.v2.InitReplicationResponse> getInitReplicationMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "InitReplication",
      requestType = com.aruna.api.dataproxy.services.v2.InitReplicationRequest.class,
      responseType = com.aruna.api.dataproxy.services.v2.InitReplicationResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.aruna.api.dataproxy.services.v2.InitReplicationRequest,
      com.aruna.api.dataproxy.services.v2.InitReplicationResponse> getInitReplicationMethod() {
    io.grpc.MethodDescriptor<com.aruna.api.dataproxy.services.v2.InitReplicationRequest, com.aruna.api.dataproxy.services.v2.InitReplicationResponse> getInitReplicationMethod;
      ...
      synchronized (DataproxyServiceGrpc.class) {
        if ((getInitReplicationMethod = DataproxyServiceGrpc.getInitReplicationMethod) == null) {
          DataproxyServiceGrpc.getInitReplicationMethod = getInitReplicationMethod =
              io.grpc.MethodDescriptor.<com.aruna.api.dataproxy.services.v2.InitReplicationRequest, com.aruna.api.dataproxy.services.v2.InitReplicationResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "InitReplication"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.aruna.api.dataproxy.services.v2.InitReplicationRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.aruna.api.dataproxy.services.v2.InitReplicationResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void requestReplication(com.aruna.api.dataproxy.services.v2.RequestReplicationRequest request,
        io.grpc.stub.StreamObserver<com.aruna.api.dataproxy.services.v2.RequestReplicationResponse> responseObserver) {
     ...
     * </pre>
     */
    default void initReplication(com.aruna.api.dataproxy.services.v2.InitReplicationRequest request,
        io.grpc.stub.StreamObserver<com.aruna.api.dataproxy.services.v2.InitReplicationResponse> responseObserver) {
  ...
  public static final class DataproxyServiceStub
     ...
     * </pre>
     */
    public void requestReplication(com.aruna.api.dataproxy.services.v2.RequestReplicationRequest request,
        io.grpc.stub.StreamObserver<com.aruna.api.dataproxy.services.v2.RequestReplicationResponse> responseObserver) {
     ...
     * </pre>
     */
    public void initReplication(com.aruna.api.dataproxy.services.v2.InitReplicationRequest request,
        io.grpc.stub.StreamObserver<com.aruna.api.dataproxy.services.v2.InitReplicationResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
  ...
  public static final class DataproxyServiceBlockingStub
     ...
     * </pre>
     */
    public com.aruna.api.dataproxy.services.v2.RequestReplicationResponse requestReplication(com.aruna.api.dataproxy.services.v2.RequestReplicationRequest request) {
     ...
     * </pre>
     */
    public com.aruna.api.dataproxy.services.v2.InitReplicationResponse initReplication(com.aruna.api.dataproxy.services.v2.InitReplicationRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class DataproxyServiceFutureStub
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.aruna.api.dataproxy.services.v2.RequestReplicationResponse> requestReplication(
        com.aruna.api.dataproxy.services.v2.RequestReplicationRequest request) {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.aruna.api.dataproxy.services.v2.InitReplicationResponse> initReplication(
        com.aruna.api.dataproxy.services.v2.InitReplicationRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_REQUEST_REPLICATION:
          serviceImpl.requestReplication((com.aruna.api.dataproxy.services.v2.RequestReplicationRequest) request,
              (io.grpc.stub.StreamObserver<com.aruna.api.dataproxy.services.v2.RequestReplicationResponse>) responseObserver);
          break;
        case METHODID_INIT_REPLICATION:
          serviceImpl.initReplication((com.aruna.api.dataproxy.services.v2.InitReplicationRequest) request,
              (io.grpc.stub.StreamObserver<com.aruna.api.dataproxy.services.v2.InitReplicationResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.aruna.api.dataproxy.services.v2.RequestReplicationRequest,
              com.aruna.api.dataproxy.services.v2.RequestReplicationResponse>(
                service, METHODID_REQUEST_REPLICATION)))
        .addMethod(
          getInitReplicationMethod(),
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.aruna.api.dataproxy.services.v2.InitReplicationRequest,
              com.aruna.api.dataproxy.services.v2.InitReplicationResponse>(
  ...
  private static final class DataproxyServiceMethodDescriptorSupplier
    ...
    DataproxyServiceMethodDescriptorSupplier(java.lang.String methodName) {
