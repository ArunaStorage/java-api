...
public final class DatasetObjectsServiceGrpc {
      ...
      synchronized (DatasetObjectsServiceGrpc.class) {
        if ((getCreateObjectGroupWithVersionMethod = DatasetObjectsServiceGrpc.getCreateObjectGroupWithVersionMethod) == null) {
          DatasetObjectsServiceGrpc.getCreateObjectGroupWithVersionMethod = getCreateObjectGroupWithVersionMethod =
              ...
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "CreateObjectGroupWithVersion"))
      ...
      synchronized (DatasetObjectsServiceGrpc.class) {
        if ((getAddVersionToObjectGroupMethod = DatasetObjectsServiceGrpc.getAddVersionToObjectGroupMethod) == null) {
          DatasetObjectsServiceGrpc.getAddVersionToObjectGroupMethod = getAddVersionToObjectGroupMethod =
              ...
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "AddVersionToObjectGroup"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
      ...
      synchronized (DatasetObjectsServiceGrpc.class) {
        if ((getGetObjectGroupMethod = DatasetObjectsServiceGrpc.getGetObjectGroupMethod) == null) {
          DatasetObjectsServiceGrpc.getGetObjectGroupMethod = getGetObjectGroupMethod =
              ...
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetObjectGroup"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
      ...
      synchronized (DatasetObjectsServiceGrpc.class) {
        if ((getGetCurrentObjectGroupMethod = DatasetObjectsServiceGrpc.getGetCurrentObjectGroupMethod) == null) {
          DatasetObjectsServiceGrpc.getGetCurrentObjectGroupMethod = getGetCurrentObjectGroupMethod =
              io.grpc.MethodDescriptor.<com.github.ScienceObjectsDB.java_api.models.ID, com.github.ScienceObjectsDB.java_api.services.GetObjectGroupVersionResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetCurrentObjectGroup"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.github.ScienceObjectsDB.java_api.models.ID.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
      ...
      synchronized (DatasetObjectsServiceGrpc.class) {
        if ((getGetObjectGroupVersionMethod = DatasetObjectsServiceGrpc.getGetObjectGroupVersionMethod) == null) {
          DatasetObjectsServiceGrpc.getGetObjectGroupVersionMethod = getGetObjectGroupVersionMethod =
              ...
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetObjectGroupVersion"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
      ...
      synchronized (DatasetObjectsServiceGrpc.class) {
        if ((getGetObjectGroupVersionsMethod = DatasetObjectsServiceGrpc.getGetObjectGroupVersionsMethod) == null) {
          DatasetObjectsServiceGrpc.getGetObjectGroupVersionsMethod = getGetObjectGroupVersionsMethod =
              ...
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetObjectGroupVersions"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.github.ScienceObjectsDB.java_api.models.ID.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
      ...
      synchronized (DatasetObjectsServiceGrpc.class) {
        if ((getFinishObjectUploadMethod = DatasetObjectsServiceGrpc.getFinishObjectUploadMethod) == null) {
          DatasetObjectsServiceGrpc.getFinishObjectUploadMethod = getFinishObjectUploadMethod =
              ...
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "FinishObjectUpload"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.github.ScienceObjectsDB.java_api.models.ID.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
  ...
  public static DatasetObjectsServiceStub newStub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<DatasetObjectsServiceStub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<DatasetObjectsServiceStub>() {
        @java.lang.Override
        public DatasetObjectsServiceStub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
          return new DatasetObjectsServiceStub(channel, callOptions);
        }
      };
    return DatasetObjectsServiceStub.newStub(factory, channel);
  }
  ...
  public static DatasetObjectsServiceBlockingStub newBlockingStub(
    ...
    io.grpc.stub.AbstractStub.StubFactory<DatasetObjectsServiceBlockingStub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<DatasetObjectsServiceBlockingStub>() {
        @java.lang.Override
        public DatasetObjectsServiceBlockingStub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
          return new DatasetObjectsServiceBlockingStub(channel, callOptions);
        }
      };
    return DatasetObjectsServiceBlockingStub.newStub(factory, channel);
  }
  ...
  public static DatasetObjectsServiceFutureStub newFutureStub(
      io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<DatasetObjectsServiceFutureStub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<DatasetObjectsServiceFutureStub>() {
        @java.lang.Override
        public DatasetObjectsServiceFutureStub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
          return new DatasetObjectsServiceFutureStub(channel, callOptions);
        }
      };
    return DatasetObjectsServiceFutureStub.newStub(factory, channel);
  }
  ...
  public static abstract class DatasetObjectsServiceImplBase implements io.grpc.BindableService {
    ...
    public void createObjectGroupWithVersion(com.github.ScienceObjectsDB.java_api.services.CreateObjectGroupWithVersionRequest request,
      ...
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getCreateObjectGroupWithVersionMethod(), responseObserver);
    }
    ...
    public void addVersionToObjectGroup(com.github.ScienceObjectsDB.java_api.services.AddVersionToObjectGroupRequest request,
        io.grpc.stub.StreamObserver<com.github.ScienceObjectsDB.java_api.services.GetObjectGroupVersionResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getAddVersionToObjectGroupMethod(), responseObserver);
    }
    ...
    public void getObjectGroup(com.github.ScienceObjectsDB.java_api.models.ID request,
        io.grpc.stub.StreamObserver<com.github.ScienceObjectsDB.java_api.services.GetObjectGroupVersionResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getGetObjectGroupMethod(), responseObserver);
    }
    ...
    public void getCurrentObjectGroup(com.github.ScienceObjectsDB.java_api.models.ID request,
        io.grpc.stub.StreamObserver<com.github.ScienceObjectsDB.java_api.services.GetObjectGroupVersionResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getGetCurrentObjectGroupMethod(), responseObserver);
    }
    ...
    public void getObjectGroupVersion(com.github.ScienceObjectsDB.java_api.services.GetObjectGroupVersionRequest request,
      ...
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getGetObjectGroupVersionMethod(), responseObserver);
    }
    ...
    public void getObjectGroupVersions(com.github.ScienceObjectsDB.java_api.models.ID request,
      ...
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getGetObjectGroupVersionsMethod(), responseObserver);
    }
    ...
    public void finishObjectUpload(com.github.ScienceObjectsDB.java_api.models.ID request,
      ...
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getFinishObjectUploadMethod(), responseObserver);
    }
  ...
  /**
   */
  public static final class DatasetObjectsServiceStub extends io.grpc.stub.AbstractAsyncStub<DatasetObjectsServiceStub> {
    private DatasetObjectsServiceStub(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected DatasetObjectsServiceStub build(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      return new DatasetObjectsServiceStub(channel, callOptions);
    }
  ...
  /**
   */
  public static final class DatasetObjectsServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<DatasetObjectsServiceBlockingStub> {
    private DatasetObjectsServiceBlockingStub(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected DatasetObjectsServiceBlockingStub build(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      return new DatasetObjectsServiceBlockingStub(channel, callOptions);
    }
  ...
  /**
   */
  public static final class DatasetObjectsServiceFutureStub extends io.grpc.stub.AbstractFutureStub<DatasetObjectsServiceFutureStub> {
    private DatasetObjectsServiceFutureStub(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected DatasetObjectsServiceFutureStub build(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      return new DatasetObjectsServiceFutureStub(channel, callOptions);
    }
